...
function CORRUPT.isDeveloper(user_id)
    if IsDuplicityVersion() then
        ...
        if user_id then
            ...
            return developers[CORRUPT.getUserId()] or false
        end
    end
end
...
function CORRUPT.canVehicleBeSold(vehicleId)
...
function CORRUPT.canVehicleBeRented(vehicleId)
...
local uuidTypes = {
    ...
    ["encrypted"] = "日月金木水火土竹戈十大中一弓人心手口尸廿山女田難卜0123456789"
}
...
function getGenericTextInput(text)
