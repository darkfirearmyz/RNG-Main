CORRUPTTips = {
    ...
    "Support CORRUPT @ corrupt.tebex.io for some cool VIP perks!",
    "Support CORRUPT @ corrupt.tebex.io for some cool VIP perks!",
    "Support CORRUPT @ corrupt.tebex.io for some cool VIP perks!",
    "Support CORRUPT @ corrupt.tebex.io for some cool VIP perks!",
    ...
    "Check out our Website for whitelisted faction applications, https://discord.gg/corrupt5m",
    "Want to join the PD? Apply at https://discord.gg/corrupt5m",
    "Use /ooc or // to ask out of character questions",
    "To call an admin, type /calladmin",
    "To report a player you can create a player report at https://discord.gg/corrupt5m",
    ...
    "Join our discord for discussion & development news https://discord.gg/corrupt5m",
    "Join our discord for discussion & development news https://discord.gg/corrupt5m",
    "Join our discord for discussion & development news https://discord.gg/corrupt5m",
    "Join our discord for discussion & development news https://discord.gg/corrupt5m",
    "Register on our website for discussion and whitelisting applications https://discord.gg/corrupt5m",
...
Citizen.CreateThread(
    function()
        ...
        while true do
            ...
            num = math.random(1, #CORRUPTTips)
            TriggerEvent("chatMessage", "", {255, 0, 0}, "^1[CORRUPT Tips]^1  " .. "^5" .. CORRUPTTips[num], "ooc")
            Wait(600000)
        end
    end
)
