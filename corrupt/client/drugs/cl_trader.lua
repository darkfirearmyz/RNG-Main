...
RegisterNetEvent(
    "CORRUPT:updateTraderCommissions",
...
Citizen.CreateThread(
    function()
        local k = CORRUPT.loadAnimDict("mini@strip_club@idles@bouncer@base")
        for l, m in pairs(b.trader) do
            ...
            CORRUPT.createDynamicPed(
                m.dealerModel,
                m.dealerPos + vector3(0.0, 0.0, -1.0),
                m.dealerHeading,
                true,
            ...
            function()
                if a == "Legal" then
                    RageUI.ButtonWithStyle(
                        "Sell Copper",
                        "£" .. getMoneyStringFormatted(c["Copper"]),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellCopper")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                        end,
                        RMenu:Get("trader", "seller")
                    ...
                    RageUI.ButtonWithStyle(
                        "Sell Limestone",
                        "£" .. getMoneyStringFormatted(c["Limestone"]),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellLimestone")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                    ...
                    RageUI.ButtonWithStyle(
                        "Sell Gold",
                        "£" .. getMoneyStringFormatted(c["Gold"]),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellGold")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                    ...
                    RageUI.ButtonWithStyle(
                        "Sell Diamond",
                        "£" .. getMoneyStringFormatted(c["Diamond"]),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellDiamond")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellAll")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                ...
                elseif a == "Weed" then
                    RageUI.ButtonWithStyle(
                        "Sell Weed",
                        "£" .. getMoneyStringFormatted(c["Weed"] or 0),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellWeed")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                ...
                elseif a == "Cocaine" then
                    RageUI.ButtonWithStyle(
                        "Sell Cocaine",
                        "£" .. getMoneyStringFormatted(c["Cocaine"] or 0),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellCocaine")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                ...
                elseif a == "Meth" then
                    RageUI.ButtonWithStyle(
                        "Sell Meth",
                        "£" .. getMoneyStringFormatted(c["Meth"] or 0),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellMeth")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                ...
                elseif a == "Heroin" then
                    RageUI.ButtonWithStyle("Sell Heroin","£" .. getMoneyStringFormatted(c["Heroin"] or 0),{RightLabel = "→→→"},true,function(m, n, o)
                        if o then
                            if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                TriggerServerEvent("CORRUPT:sellHeroin")
                            else
                                tvRP.notify("Exit your vehicle.")
                            end
                        end
                    ...
                    RageUI.ButtonWithStyle("Sell All Heroin","£" .. getMoneyStringFormatted(c["Heroin"] or 0),{RightLabel = "→→→"},true,function(m, n, o)
                        if o then
                            if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                TriggerServerEvent("CORRUPT:sellHeroin", true)
                            else
                                tvRP.notify("Exit your vehicle.")
                            end
                        end
                ...
                elseif a == "LSDNorth" then
                    RageUI.ButtonWithStyle(
                        "Sell LSD",
                        "£" .. getMoneyStringFormatted(c["LSDNorth"] or 0),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellLSDNorth")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
                ...
                elseif a == "LSDSouth" then
                    RageUI.ButtonWithStyle(
                        "Sell LSD",
                        "£" .. getMoneyStringFormatted(c["LSDSouth"] or 0),
                        {RightLabel = "→→→"},
                        true,
                        function(m, n, o)
                            if o then
                                if GetVehiclePedIsIn(CORRUPT.getPlayerPed(), false) == 0 then
                                    TriggerServerEvent("CORRUPT:sellLSDSouth")
                                else
                                    tvRP.notify("Exit your vehicle.")
                                end
                            end
    ...
    function(p, q)
        if q then
            ...
            local u = function(s)
                ...
                DrawText3D(
                    b.trader[s.traderId].position.x,
                    b.trader[s.traderId].position.y,
                    b.trader[s.traderId].position.z,
            ...
            for y, l in pairs(b.trader) do
                CORRUPT.createArea("trader_" .. y, l.position, 1.5, 6, r, t, u, {traderId = y, traderName = l.type})
            end
        end
    end
)
RegisterNetEvent(
    "CORRUPT:updateTraderPrices",
    function(z, A, B, C, i, j, D, E, F, G)
        c["Weed"] = z or 0
        c["Cocaine"] = A or 0
        c["Meth"] = B or 0
        c["Heroin"] = C or 0
