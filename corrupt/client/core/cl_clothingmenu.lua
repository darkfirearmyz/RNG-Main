...
RMenu.Add("CORRUPTclothing", "changePed", RageUI.CreateSubMenu(RMenu:Get("CORRUPTclothing", "mainMenu"), "", "Change Gender"))
RMenu.Add(
    "CORRUPTclothing",
    "changeClothing",
    RageUI.CreateSubMenu(RMenu:Get("CORRUPTclothing", "mainMenu"), "", "Change your Clothes")
)
RMenu.Add("CORRUPTclothing", "clearProps", RageUI.CreateSubMenu(RMenu:Get("CORRUPTclothing", "mainMenu"), "", "Clear Props"))
local a = {
...
local v = {
    ...
    ["Glasses"] = {offset = vector3(0.0, 0.5, 0.68), point = vector3(0.0, 0.0, 0.68), fov = 50.1},
    ["Ear Accessories"] = {offset = vector3(0.0, 0.5, 0.68), point = vector3(0.0, 0.0, 0.68), fov = 50.1},
    ["Face"] = {offset = vector3(0.0, 0.5, 0.68), point = vector3(0.0, 0.0, 0.68), fov = 50.1},
        ...
        while true do
            ...
            for H = 1, #r do
                if #(G - r[H]) <= 2.5 and not t then
                    ...
                    h = true
                    RageUI.Visible(RMenu:Get("CORRUPTclothing", "mainMenu"), true)
                elseif s == H then
                    ...
                    if not RageUI.Visible(RMenu:Get("CORRUPTclothing", "changeClothing")) then
                        F()
                    end
                end
            end
...
RageUI.CreateWhile(
    1.0,
    RMenu:Get("CORRUPTclothing", "mainMenu"),
    nil,
    function()
        if not n then
            RageUI.IsVisible(
                ...
                function()
                    RageUI.Button(
                        ...
                        RMenu:Get("CORRUPTclothing", "changeClothing")
                    )
                    if not inOrganHeist then
                        RageUI.Button(
                            ...
                            RMenu:Get("CORRUPTclothing", "changePed")
                        )
                    end
                    RageUI.Button(
                        "~y~Wardrobe",
                        ...
                        function(L, M, N)
                            if N then
                                if tvRP.isPlusClub() or tvRP.isPlatClub() then
                                    TriggerEvent("CORRUPT:openOutfitMenu")
                                else
                                    tvRP.notify(
                                        "~y~You need to be a subscriber of CORRUPT Plus or CORRUPT Platinum to use this feature."
                                    )
                                    tvRP.notify("~y~Available @ store.corruptstudios.co.uk")
                                end
                            end
                        end
                    )
                    RageUI.Button(
                        "Apply Outfit Code",
                        "Applys an outfit code given by a player with ~y~CORRUPT Plus~w~ or ~y~CORRUPT Platinum~w~.",
                        {RightLabel = ">>>"},
                        function(L, M, N)
                            if N then
                                CORRUPT.clientPrompt(
                                    ...
                                    function(O)
                                        ...
                                        if #P == 5 then
                                            TriggerServerEvent("CORRUPT:applyOutfitCode", string.upper(P))
                                        else
                    ...
                    if PlayerIsInGang then
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    TriggerServerEvent("CORRUPT:applyGangFit", gangID)
                                end
                            end
                        )
                    end
                    RageUI.Button(
                        ...
                        RMenu:Get("CORRUPTclothing", "clearProps")
                    )
                end,
                function()
                end
                ...
                function()
                        ...
                        function(L, M, N)
                            if N then
                                if GetEntityHealth(PlayerPedId()) > 102 then
                                    CORRUPT.loadCustomisationPreset("DefaultMale")
                                else
                                    tvRP.notify("~r~Cannot change gender, you're dead.")
                                end
                            end
                        end,
                        function()
                    ...
                    RageUI.Button(
                        ...
                        function(L, M, N)
                            if N then
                                if GetEntityHealth(PlayerPedId()) > 102 then
                                    CORRUPT.loadCustomisationPreset("DefaultFemale")
                                else
                                    tvRP.notify("~r~Cannot change gender, you're dead.")
                                end
                            end
                                ...
                                function(L, M, N, O)
                                    ...
                                    if N then
                                        ...
                                        if k.index == 2 then
                                            ...
                                            TriggerServerEvent(
                                                "CORRUPT:saveClothingHairData",
                                                GetPedDrawableVariation(CORRUPT.getPlayerPed(), 2),
                                                GetPedHairColor(CORRUPT.getPlayerPed())
                                            )
            ...
            RageUI.IsVisible(
                ...
                function()
                    RageUI.Button(
                        ...
                        function(L, M, N)
                            if N then
                                ClearPedProp(CORRUPT.getPlayerPed(), 0)
                            end
                        end,
                        function()
                        end,
                    ...
                    RageUI.Button(
                        ...
                        function(L, M, N)
                            if N then
                                ClearPedProp(CORRUPT.getPlayerPed(), 1)
                            end
                        end,
                        function()
                        end,
                    ...
                    RageUI.Button(
                        ...
                        function(L, M, N)
                            if N then
                                ClearPedProp(CORRUPT.getPlayerPed(), 2)
                            end
                        end,
                        function()
                        end,
                    ...
                    RageUI.Button(
                        ...
                        function(L, M, N)
                            if N then
                                ClearPedProp(CORRUPT.getPlayerPed(), 6)
                            end
                        end,
                        function()
                        end,
                    ...
                    RageUI.Button(
                        ...
                        function(L, M, N)
                            if N then
                                ClearPedProp(CORRUPT.getPlayerPed(), 7)
                            end
                        end,
                        function()
                        end,
...
function current_clothing(P, i, R)
    if P == "prop" then
        if R then
            if GetPedPropTextureIndex(CORRUPT.getPlayerPed(), i) ~= nil then
                return GetPedPropTextureIndex(CORRUPT.getPlayerPed(), i)
            else
                return 0
            end
        else
            if GetPedPropIndex(CORRUPT.getPlayerPed(), i) ~= nil then
                if GetPedPropIndex(CORRUPT.getPlayerPed(), i) == -1 then
                    return GetPedPropIndex(CORRUPT.getPlayerPed(), i) + 2
                else
                    return GetPedPropIndex(CORRUPT.getPlayerPed(), i) + 1
                end
            else
                return 0
            end
    ...
    elseif P == "drawable" then
        ...
        elseif R then
            if GetPedTextureVariation(CORRUPT.getPlayerPed(), i) ~= nil then
                return GetPedTextureVariation(CORRUPT.getPlayerPed(), i)
            else
                return 0
            end
        else
            if GetPedDrawableVariation(CORRUPT.getPlayerPed(), i) ~= nil then
                return GetPedDrawableVariation(CORRUPT.getPlayerPed(), i) + 1
            else
                return 0
            end
        end
...
function get_textures(S, P, i)
    if S == "drawable" then
        ...
        j = GetNumberOfPedTextureVariations(CORRUPT.getPlayerPed(), P, i - 1)
        return j
    else
        j = GetNumberOfPedPropTextureVariations(CORRUPT.getPlayerPed(), P, i - 1)
        return j
    end
end
local function X()
...
Citizen.CreateThread(
    function()
        while true do
            if k.index ~= nil and RageUI.Visible(RMenu:Get("CORRUPTclothing", "changeClothing")) then
...
Citizen.CreateThread(
    function()
        while true do
            ...
            SetPedConfigFlag(CORRUPT.getPlayerPed(), 35, false)
            Wait(0)
        end
    end
)
    ...
    function(D, E)
        if E then
            for a4, a5 in pairs(r) do
                tvRP.addBlip(a5.x, a5.y, a5.z, 73, 3, "Clothing Store", 0.7)
                tvRP.addMarker(
                    a5.x,
                    a5.y,
                    a5.z,
