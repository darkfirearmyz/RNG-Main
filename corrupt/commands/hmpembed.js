...
exports.runcmd = (fivemexports, client, message, params) => {
    let embed = {
        "title": "CORRUPT His Majesty's Prison Service",
        ...
        "fields": [
            ...
            },
            {
                ...
                "value": "To join the Prison Service, you need to create an account on rngstudios.net and use the [application](https://soon). Make sure to be in the RNG HMPS Official [Discord](https://discord.gg/) server.",
            },
            {
