...
cfg.items = {
    ...
    ["melee_import"] = {
        name = "Melee Import",
        description = "To use this item open a Weapon Ticket in the CORRUPT Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["pistol_import"] = {
    ...
    ["corrupt_plus"] = {
        name = "Corrupt Plus (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["corrupt_platinum"] = {
        name = "Corrupt Platinum (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["supporter"] = {
    ...
    ["lock_slot"] = {
        name = "Lock Slot",
        description = "To use this item open a Ticket in the CORRUPT Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["model_ajustment"] = {
    ...
    ["import_slot"] = {
        name = "Import Slot",
        description = "To use this item as an import slot open a Ticket in the CORRUPT Support tickets Discord.",
        manuallyRedeemable = true,
        canTransfer = true,
        args = "import_slot"
    },
    ...
    ["halloween_bundle_2024"] = {
        name = "Halloween Bundle 2024",
        manuallyRedeemable = true,
        canTransfer = true,
    },
}
...
local customCars = {
    ...
    ["Offroad"] = {
        ...
        ["19rcorruptffroad"] = "Dodge Ram 2019",
