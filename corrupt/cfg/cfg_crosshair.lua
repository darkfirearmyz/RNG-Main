...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("corrupt_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("corrupt_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("corrupt_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("corrupt_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("corrupt_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("corrupt_crosshair_gap")
    ...
    local red = GetResourceKvpInt("corrupt_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("corrupt_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("corrupt_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('corrupt_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('corrupt_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('corrupt_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('corrupt_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('corrupt_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('corrupt_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('corrupt_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('corrupt_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('corrupt_crosshair_green', cfg.options.colour.green)
end
