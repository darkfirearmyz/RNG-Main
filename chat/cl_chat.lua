...
local function getPlayerNameSafe()
  if GetResourceState("corrupt") == "started" then
    local name = exports["corrupt"]:getPlayerName(PlayerId())
...
local function getUserIdSafe()
  if GetResourceState("corrupt") == "started" then
    local user_id = exports["corrupt"]:getUserId()
...
AddEventHandler("CORRUPT:hideChat",function(flag)
  hideChat = flag
end)

AddEventHandler("CORRUPT:chatReduceOpacity", function(flag)
  isReducedOpacity = flag
end)

AddEventHandler("onClientResourceStart", function(resourceName)
  if resourceName == "corrupt" then
    isFirstLoad = true
  end
end)