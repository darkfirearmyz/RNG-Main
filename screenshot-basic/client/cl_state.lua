...
RegisterNetEvent("CORRUPTELS:changeStage", function(netId, stage)
...
RegisterNetEvent("CORRUPTELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("CORRUPTELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("CORRUPTELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("CORRUPTELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("CORRUPTELS:indicatorChange", function(netId, indicator, enabled)
